...
namespace GameCreatures.IntegrationTests.CommanderTests
{
    ...
    public class AutoAttack_Should
    {
        ...
        public void ChooseCorrectTarget()
        {
            ...
            var target1 = new Creature("Dummy", 10, 90, default, ArmorType.Light, _finder);
            var target2 = new Creature("Dummy", 10, 100, default, ArmorType.Medium, _finder);
        ...
        public void ChooseBestAttacker_SingleTargetArmy()
        {
            ...
            var target1 = new Creature("Dummy", 10, 100, default, ArmorType.Light, _finder);
            var attacker1 = new Creature("Dummy", 50, 100, AttackType.Magic, default, _finder);
            var attacker2 = new Creature("Dummy", 50, 100, AttackType.Melee, default, _finder);
            var commander1 = new Commander("Cmd1", new List<Creature> { attacker1, attacker2 });
        ...
        public void ChooseTarget_ThatWouldDie()
        {
            ...
            var target1 = new Creature("Dummy", 10, 60, default, ArmorType.Light, _finder);
            var target2 = new Creature("Dummy", 10, 100, default, ArmorType.Medium, _finder);
            var attacker1 = new Creature("Dummy", 50, 100, AttackType.Ranged, default, _finder);
            var attacker2 = new Creature("Dummy", 55, 100, AttackType.Melee, default, _finder);
            var commander1 = new Commander("Cmd1", new List<Creature> { attacker1, attacker2 });
            var commander2 = new Commander("Cmd2", new List<Creature> { target1, target2 });
